package com.example.zsq.easyshop.components;
    ...
    public static DisplayImageOptions build() {
        if (options == null) {
            options = new DisplayImageOptions.Builder()
                    .showImageForEmptyUri(R.mipmap.morentouxiang)/*如果空url显示什么*/
                    .showImageOnLoading(R.mipmap.morentouxiang)/*加载中显示什么*/
                    .showImageOnFail(R.mipmap.morentouxiang)/*加载失败显示什么*/
