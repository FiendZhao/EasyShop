package com.example.zsq.easyshop.me.persiongoods;
...
import com.example.zsq.easyshop.shop.ShopAdapter;
import com.example.zsq.easyshop.shop.ShopView;
...
public class PersonGoodsActivity extends MvpActivity<ShopView,PersonGoodsPresenter> implements ShopView{
    ...
    /*下拉刷新和上拉加载的控件*/
    @BindView(R.id.refreshLayout) PtrClassicFrameLayout ptrFrameLayout;
    @BindView(R.id.recyclerView) RecyclerView recyclerView;
    @BindView(R.id.tv_load_error) TextView tv_load_error;
    @BindView(R.id.tv_load_empty) TextView tv_load_empty;

    @BindString(R.string.load_more_end) String load_more_end;
    ...
    public void onContentChanged() {
        ...
        shopAdapter.setListener(new ShopAdapter.onItemClickedListener() {
            ...
            public void onPhotoClicked(GoodsInfo goodsInfo) {
                //跳转到详情页，来自我的商品页面
                Intent
                    intent = ShangPinXiangQingActivity.getStartIntent(PersonGoodsActivity.this, goodsInfo.getUuid(), 1);
