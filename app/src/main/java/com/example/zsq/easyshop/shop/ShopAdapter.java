...
public class ShopAdapter extends RecyclerView.Adapter<ShopAdapter.ShopViewHolder>{
  ...
  @Override public void onBindViewHolder(ShopViewHolder holder, final int position) {
    //商品名称
    ...
    //卖家名
    holder.tv_maijianame.setText(list.get(position).getMaster());
    //图片加载
  ...
  class ShopViewHolder extends RecyclerView.ViewHolder{
    @BindView(R.id.iv_item_recycler)ImageView imageView;
    @BindView(R.id.tv_item_name)TextView tv_name;
    @BindView(R.id.tv_item_maijianame)TextView tv_maijianame;
    @BindView(R.id.tv_item_price)TextView tv_price;
